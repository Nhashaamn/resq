...
class Tsunami extends StatefulWidget {
  ...
  @override
  State<Tsunami> createState() => _TsunamiState();
}

class _TsunamiState extends State<Tsunami> with TickerProviderStateMixin {
